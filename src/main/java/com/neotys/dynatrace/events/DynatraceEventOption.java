...
/**
 * Created by anouvel on 15/12/2017.
 */
enum DynatraceEventOption implements Option {
	...
	DynatraceEventOption(final String name, final Option.OptionalRequired optionalRequired,
