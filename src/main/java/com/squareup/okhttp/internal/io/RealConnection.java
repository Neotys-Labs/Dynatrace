...
/**
 * Integrate fix https://github.com/square/okhttp/issues/2426 / https://github.com/square/okhttp/issues/2467 into okhttp 2.7.5<br>
 * - it fixes usage of okhttp through proxy with basic authentication that respond with header "Connection: closed"<br> 
 *   between auth challenge and sending basic token<br>  
 * @author lbuttigieg
 *
 */
