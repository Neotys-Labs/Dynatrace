...
All features of this experimental version are natively available into Neoload 7.5 and up except the custom action "DynatraceSanityCheck". See [Neoload documentation](https://www.neotys.com/documents/doc/neoload/latest/en/html/#5900.htm). \
